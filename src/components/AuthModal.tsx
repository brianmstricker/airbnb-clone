...
const AuthModal = ({ closeAuthModal, loginPage }: AuthModalProps) => {
 ...
 return (
  <>
   {!loginPage ? (
    ...
    <div className="z-50 w-full h-full relative mx-auto max-w-[568px] min-h-[682px] rounded-xl -top-24 md:-top-0">
     <div className="md:border md:border-gray-400 md:rounded-xl px-4 py-5 md:mt-36 md:pb-16">
      <header className="flex items-center px-4 py-5 md:px-0 md:py-0">
       <h3 className="text-lg font-semibold mx-auto">Log in or Sign up</h3>
      </header>
     ...
     <div className="mt-8 text-center">
      <div className="flex items-center justify-center w-full mx-auto h-[1.5px] bg-gray-300">
       ...
       <div className="mt-8 text-center">
        <button
         className="bg-white w-full rounded-md p-1 py-3 sm:p-3 text-black border border-black font-medium flex items-center justify-center relative text-[3.75vw] [@media(min-width:400px)]:text-base"
         onClick={() => signIn("google", { redirect: false })}
        >
         <FcGoogle className="absolute left-3" size={22} />
         Continue with Google
        ...
        <button
         className="bg-white w-full rounded-md p-1 py-3 sm:p-3 text-black border border-black mt-4 font-medium flex items-center justify-center relative text-[3.75vw] [@media(min-width:400px)]:text-base"
         onClick={() => signIn("github", { redirect: false })}
        >
         <FaGithub className="absolute left-3" size={22} />
         Continue with Github
