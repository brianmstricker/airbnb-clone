...
const Header = () => {
  ...
  return (
    <nav className="md:border-b border-b-gray-200 mt-4 pb-5">
      <div className="container hidden md:flex items-center justify-between">
        ...
        <div className="flex items-center gap-6 relative">
          ...
          {showUserMenu && (
            <UserMenu className="absolute shadow-sm shadow-gray-300 bg-[#F3F3F3] top-[150%] right-0 min-w-[240px] z-10 rounded-xl" />
          )}
        </div>
      </div>
    </nav>
